library(sosPhenotypes)

# Maximum number of cores to be used:
maxCores <- parallel::detectCores()

# The folder where the study intermediate and result files will be written:
outputFolder <- "D:/studyResults/sosPhenotypes"
...
privateKeyFileName <- ""
userName <- ""
sosPhenotypes::uploadResults(outputFolder, privateKeyFileName, userName)
